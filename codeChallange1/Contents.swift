...
func findPairMultiplication( inputList:[Int] ) -> Int {
    
    for item in inputList {
        
         if inputList.contains(2020 - item) {
...
findPairMultiplication(inputList: input)

//var multiplication = 588 * 1432
findTripledMultiplication(inputList: sorted)
//var multiplication2 = 16 * 1657 * 347
